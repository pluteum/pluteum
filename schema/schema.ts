...
export default makeExecutableSchema({
    typeDefs: [query, Upload, User, Library, Author, Book, File],
    resolvers: [UploadResolvers, UserResolvers, LibraryResolvers, AuthorResolvers, BookResolvers, FileResolvers]
})